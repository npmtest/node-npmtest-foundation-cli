...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-foundation-cli/node_modules/foundation-cli/lib/commands/help.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-foundation-cli/node_modules/foundation-cli/lib/commands/help.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-foundation-cli/node_modules/foundation-cli/lib/commands/</a> &#187; help.js</div>
</div>
<div class="body">
...
&nbsp;
module.exports = <span class="fstat-no" title="function not covered" >function(args, options) {</span>
<span class="cstat-no" title="statement not covered" >  var say;</span>
<span class="cstat-no" title="statement not covered" >  if (typeof args === 'undefined' || args.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >    say = 'default'</span>
  } else {
<span class="cstat-no" title="statement not covered" >    say = args[0]</span>
  }
  // A line break is added before and after the help text for good measure
<span class="cstat-no" title="statement not covered" >  say = '\n' + helpText[say].join('\n') + '\n\n'</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  process.stdout.write(say);</span>
}
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
